...
static NSString * VIEW_TITLE = @"Privacy Policy";
static NSString * NAVIGATION_BAR_BACK_ICON_NAME = @"NavigationBarBackIconRed";
static NSString * URL = @"http://getmagpie.com/privacy";
...
@property (nonatomic, strong) UIWebView *privacyWebView;
 ...
 * @return UIWebView
 */
-(UIWebView *)privacyWebView {
    if (_privacyWebView == nil) {
        _privacyWebView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, self.screenWidth, self.screenHeight)];
        _privacyWebView.backgroundColor = [UIColor whiteColor];
        _privacyWebView.scrollView.bounces = NO;
        _privacyWebView.delegate = self;
        NSURL *url = [NSURL URLWithString:URL];
        NSURLRequest *request = [NSURLRequest requestWithURL:url];
        [_privacyWebView loadRequest:request];
    }
    return _privacyWebView;
}
