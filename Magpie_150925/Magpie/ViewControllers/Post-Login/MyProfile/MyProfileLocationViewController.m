...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MyProfileViewController *myProfileViewController = [self.navigationController.viewControllers objectAtIndex:currentViewControllerIndex-1];
    [myProfileViewController setLocation:self.results[indexPath.row]];
    [self goBack];
}
