...
static NSString * VALUE_PROP = @"Host someone at your place and be hosted during your next trip";

static NSString * VALUE_PROP_SCREEN = @"ValuePropSecondScreen";
static NSString * VALUE_PROP_SCREEN_BLUR = @"ValuePropSecondScreenBlur";
static NSString * VALUE_PROP_ICON = @"ValuePropSecondScreenBigIcon";

@interface ValuePropSecondView()
...
@implementation ValuePropSecondView
