...
static NSString * VALUE_PROP = @"Explore places and book right from your phone";
static NSString * VALUE_PROP_SCREEN = @"ValuePropThirdScreen";
static NSString * VALUE_PROP_SCREEN_BLUR = @"ValuePropThirdScreenBlur";
static NSString * VALUE_PROP_ICON = @"ValuePropThirdScreenBigIcon";


@interface ValuePropThirdView()
...
@implementation ValuePropThirdView
...
-(UIImageView *)valuePropIcon {
    if (_valuePropIcon == nil) {
        _valuePropIcon = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.viewHeight/2 - 190, self.viewWidth, 190)];
