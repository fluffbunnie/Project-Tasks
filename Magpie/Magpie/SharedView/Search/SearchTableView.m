...
@property (nonatomic, strong) UIButton *blackMask;
...
//        _blackMask = [[UIButton alloc] initWithFrame:CGRectMake(-52, -25, screenRect.size.width, screenRect.size.height)];
//        _blackMask.backgroundColor = [UIColor lightGrayColor];
//        _blackMask.alpha = 0.0f;
//        _blackMask.userInteractionEnabled = YES;
//        [_blackMask addTarget:self action:@selector(cancelSearch:) forControlEvents:UIControlEventTouchUpInside];
        
//        UITapGestureRecognizer *singleFingerTap =
//        [[UITapGestureRecognizer alloc] initWithTarget:self
//                                                action:@selector(handleSingleTap:)];
//        [_blackMask addGestureRecognizer:singleFingerTap];
...
//    _blackMask.userInteractionEnabled = YES;
//    [_blackMask addTarget:self action:@selector(cancelSearch:) forControlEvents:UIControlEventTouchUpInside];
//    _blackMask.alpha  = 0.6f;
////    [self addSubview:_blackMask];
//    [self insertSubview:_blackMask belowSubview:_shadowView];
