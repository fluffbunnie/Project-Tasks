...
-(UITableView *)settingItemsTable {
    if (_settingItemsTable == nil) {
        ...
        _settingItemsTable.backgroundColor = [FontColor profileImageBackgroundColor];
...
-(void)viewDidLoad {
    ...
    self.view.backgroundColor = [FontColor profileImageBackgroundColor];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) title.text = @"Frequently Asked Questions";
    if (indexPath.row == 1) title.text = @"Privacy Policy";
    if (indexPath.row == 2) title.text = @"Terms of Service";
