...
/**
 * RequestInvitationSuccessView delegate
 * Handle the behavior when user click on how it works button
 */
-(void)sneakPeekAtHowItWorks {
    HowItWorksViewController *howItWorksViewController = [[HowItWorksViewController alloc] init];
    howItWorksViewController.capturedBackground = [Device captureScreenshot];
    [self.navigationController pushViewController:howItWorksViewController animated:NO];
}
