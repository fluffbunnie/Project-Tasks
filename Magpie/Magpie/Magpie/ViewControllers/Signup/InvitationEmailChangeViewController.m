//
//  InvitationEmailChangeViewController.m
//  Magpie
//
...
@interface InvitationEmailChangeViewController ()
...
@implementation InvitationEmailChangeViewController
...
-(void)textFieldDidChange {
    ...
    self.saveButton.enabled = ![self.emailTextField.text isEqualToString:self.email] && [EmailValidation validateEmail:currentText];
}
...
-(void)saveButtonClick {
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        if (finished) {
            ...
            if ([previousViewController isKindOfClass:InvitationStatusViewController.class]) {
                [(InvitationStatusViewController *)previousViewController setEmail:[self.email lowercaseString]];;
            } else if ([previousViewController isKindOfClass:InvitationStatusWithPushNotificationViewController.class]){
                [(InvitationStatusWithPushNotificationViewController *) previousViewController setEmail:[self.email lowercaseString]];
            }
