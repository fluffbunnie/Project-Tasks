...
-(SquircleProfileImage *)profileImage {
    if (_profileImage == nil) {
        _profileImage = [[SquircleProfileImage alloc] initWithFrame:CGRectMake(15, 20, 45, 45)];
    }
...
-(UILabel *)hostName {
    if (_hostName == nil) {
        _hostName = [[UILabel alloc] initWithFrame:CGRectMake(75, 25, self.viewWidth - 90, 20)];
    }
    return _hostName;
}
...
-(UILabel *)durationLabel {
    if (_durationLabel == nil) {
        _durationLabel = [[UILabel alloc] initWithFrame:CGRectMake(75, 47, self.viewWidth - 90, 18)];
...
-(UIImageView *)propertyPhoto {
    if (_propertyPhoto == nil) {
        _propertyPhoto = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.containerView.frame), 100)];
