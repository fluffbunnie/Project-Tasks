...
static NSString *IMAGE_ICON_NAME = @"MyMessageEmptyIcon";
static NSString *TITLE_TEXT = @"You haven’t said a word yet";
static NSString *DESCRIPTION_TEXT = @"Get started with one of your Favorites.";
static NSString *ACTION_BUTTON_TITLE = @"Let’s go to Favorites";

@interface MyMessageEmptyView()
...
@implementation MyMessageEmptyView
...
-(UIImageView *)iconImage {
    if (_iconImage == nil) {
        _iconImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, (self.viewHeight - 90 - 280)/2, self.viewWidth, 180)];
...
-(void)actionButtonClick {
    [self.emptyViewDelegate goToFavorites];
}
