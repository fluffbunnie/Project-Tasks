...
static NSString * VALUE_PROP = @"Each member and listing is carefully vetted by Magpie staff";
static NSString * VALUE_PROP_SCREEN = @"ValuePropFourthScreen";
static NSString * VALUE_PROP_SCREEN_BLUR = @"ValuePropFourthScreenBlur";
static NSString * VALUE_PROP_ICON = @"ValuePropFourthScreenBigIcon";

@interface ValuePropFourthView()
...
@implementation ValuePropFourthView
...
-(id)init {
    ...
    self = [super initWithFrame:CGRectMake(3 * self.viewWidth, 0, self.viewWidth, self.viewHeight)];
    if (self) {
