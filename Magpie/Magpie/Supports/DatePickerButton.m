...
-(UIView *)backgroundBorderView {
    if (_backgroundBorderView == nil) {
        ...
        _backgroundBorderView.layer.cornerRadius = self.frame.size.height / 2.0;
...
-(UILabel *)normalPlaceHolder {
    if (_normalPlaceHolder == nil) {
        _normalPlaceHolder = [[UILabel alloc] initWithFrame:CGRectMake(self.frame.size.height/2 + 5, 0, 120, self.frame.size.height)];
