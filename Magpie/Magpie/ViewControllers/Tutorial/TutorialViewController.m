...
-(UIPageControl *)pageControl {
    if (_pageControl == nil) {
        _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake((self.screenWidth - 60)/2, self.screenHeight - 115, 60, 8)];
...
-(void)stopAnimationAtPage:(int)page {
    if (page == 0) [self.firstValueProp stopAnimation];
    if (page == 1) [self.secondValueProp stopAnimation];
    if (page == 2) [self.thirdValueProp stopAnimation];
    if (page == 3) [self.fourthValueProp stopAnimation];
}
...
-(void)startAnimationAtPage:(int)page {
    if (page == 0) [self.firstValueProp doAnimation];
    if (page == 1) [self.secondValueProp doAnimation];
    if (page == 2) [self.thirdValueProp doAnimation];
    if (page == 3) [self.fourthValueProp doAnimation];
}
