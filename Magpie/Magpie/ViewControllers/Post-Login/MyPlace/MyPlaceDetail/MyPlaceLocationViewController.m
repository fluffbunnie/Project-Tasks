//
//  MyPlaceLocationViewController.m
//  Magpie
//
...
static NSString *SEARCH_PLACEHOLDER = @"Please enter your place's full address";

@interface MyPlaceLocationViewController ()
...
@implementation MyPlaceLocationViewController
...
-(UITextField *)searchTextField {
    if (_searchTextField == nil) {
        ...
        _searchTextField.text = self.placeLocation;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MyPlaceDetailViewController *myPlaceDetailViewController = [self.navigationController.viewControllers objectAtIndex:currentViewControllerIndex-1];
    [myPlaceDetailViewController setLocation:self.results[indexPath.row]];
    [self goBack];
}
