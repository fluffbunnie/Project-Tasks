...
static NSString * APPROVAL_REQUIRE_USER_DESCRIPTION_TITLE = @"User profile description required";
static NSString * APPROVAL_REQUIRE_USER_DESCRIPTION_MESSAGE = @"Your description required to publish your place. Please try again.";
